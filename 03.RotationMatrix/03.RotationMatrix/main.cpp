...
void UpdateConstantResource()
{
	...
	DirectX::XMMATRIX world = DirectX::XMMatrixRotationX(g_fRotaionAngle) * DirectX::XMMatrixRotationY(g_fRotaionAngle) * DirectX::XMMatrixRotationZ(g_fRotaionAngle); // 오브젝트 고유의 값
